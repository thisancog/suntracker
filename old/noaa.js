...
var sunEquationCenter = function(julianCentury) {
	var sunMeanAnomaly = degToRad(sunMeanAnomaly(julianCentury)),
		sin2m = Math.sin(2 * sunMeanAnomaly),
		sin3m = Math.sin(3 * sunMeanAnomaly);

	return Math.sin(sunMeanAnomaly) * (1.914602 - julianCentury * (0.004817 + 0.000014 * julianCentury)) + sin2m * (0.019993 - 0.000101 * julianCentury) + sin3m * 0.000289;
}
